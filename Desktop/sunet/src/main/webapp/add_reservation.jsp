...
<br><br><br><br><br><br>
<div class="d-flex flex-row" class="card">
    <div style="background-color:#4C4B16; width:400px;" class="card-body">
        <h5 style="color :white;" class="d-flex justify-content-center bold" class="card-title">Add Reservation</h5>
        <form action="AddReservationServlet" method="post">
            ...
            <button type="submit" class="btn buttoncolor">Add Reservation</button>
        </form>
        
    </div>
    <div>
    <img src="hotel.jpg" width="100%" height =500px">
    </div>
</div>
